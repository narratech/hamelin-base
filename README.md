# Hamelin - Base
Proyecto creado en **Unity 2022.3.55f1** para servir como punto de partida para algunas prácticas.

Consiste en un entorno que representa el pueblo de Hamelín, un personaje controlable por el jugador que es el flautista de Hamelín, un perro compañero y un montón de ratas preparadas para controlarse con IA.
